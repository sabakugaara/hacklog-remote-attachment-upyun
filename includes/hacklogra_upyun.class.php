...
/*					if ( self::$fs->is_url_token_signed( $url ) ) {
	...
	public static function plugin_menu() {
		$identifier  = md5( HACKLOG_RA_UPYUN_LOADER );
		$option_page = add_options_page( __( 'Hacklog Remote Attachment Upyun Options', self::textdomain ), __( 'Remote Attachment Upyun', self::textdomain ), 'manage_options', $identifier, array(
				__CLASS__,
				'plugin_options'
			)
		);
	...
	public static function plugin_options() {
        ...
        <div class="wrap">
            ...
            <form name="form1" method="post"
                ...
                <table width="100%" cellpadding="5" class="form-table">
                    <tr valign="top">
                        ...
                        <td>
                            <select id="rest_server" name="rest_server">
								<?php foreach (
									[
										'v0.api.upyun.com' => 'auto',
										'v1.api.upyun.com' => 'telecom',
										'v2.api.upyun.com' => 'unicom',
										'v3.api.upyun.com' => 'other'
									] as $the_server => $server_desc
								): ?>
                                    <option
                    ...
                    <tr valign="top">
                        <th scope="row"><label
                                    for="form_api_timeout"><?php _e( 'form API timeout(s)', self::textdomain ) ?>
                                :</label>
                        </th>
                        <td>
                    ...
                    <tr valign="top">
                        <th scope="row"><label
                                    for="form_api_allowed_ext"><?php _e( 'form API allowd ext', self::textdomain ) ?>
                                :</label>
                        </th>
                        <td>
                    ...
                    <tr valign="top">
                        <th scope="row"><label
                                    for="anti_leech_token"><?php _e( 'anti leech token key', self::textdomain ) ?>
                                :</label>
                        </th>
                        <td>
                    ...
                    <tr valign="top">
                        <th scope="row"><label
                                    for="anti_leech_timeout"><?php _e( 'anti leech timeout(s)', self::textdomain ) ?>
                                :</label>
                        </th>
                        <td>
                    ...
                    <tr valign="top">
                        <th scope="row"><label
                                    for="rest_remote_path"><?php _e( 'rest Remote path', self::textdomain ); ?>
                                :</label></th>
                        <td>
                    ...
                    <tr valign="top">
                        <th scope="row"><label
                                    for="http_remote_path"><?php _e( 'HTTP Remote path', self::textdomain ); ?>
                                :</label></th>
                        <td>
        ...
        <div class="wrap">
            ...
            <ul style="color:#999999;font-size:14px;">
                <li>
                    Upyun SDK Version: <span
                            style="color:#4e9a06;font-size:14px;"><?php echo self::$fs->version(); ?></span>
                </li>
            </ul>
            <hr/>
            <h2>Tools</h2>
