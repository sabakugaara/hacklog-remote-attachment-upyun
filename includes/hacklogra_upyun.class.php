...
############################## PUBLIC FUNCTIONS ##############################################
    ...
    public static function init()
    {
        ...
        //后面不带 /
        self::$rest_remote_path = $opts['rest_remote_path'] == '.' || $opts['rest_remote_path'] == '/' ? '' : $opts['rest_remote_path'];
        self::$http_remote_path = $opts['http_remote_path'] == '.' || $opts['http_remote_path'] == '/' ? '' : $opts['http_remote_path'];
