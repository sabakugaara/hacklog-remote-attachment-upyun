...
class Filesystem_Upyun extends UpYun {
	...
	public function build_policy( $args ) {
		$default   = array(
			'expire'               => $this->form_api_timeout,
			// 300 s
			'path'                 => '/{year}/{mon}/{random}{.suffix}',
			// full relative path
			'allow_file_ext'       => $this->form_api_allowed_ext,
			'content_length_range' => '0,' . $this->form_api_content_max_length,
			// 10MB( 10485760) 20MB ( 20971520 ),最大为100MB ( 104857600 )
